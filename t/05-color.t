...
subtest {
    ...
    if $out ~~ m{^<[0..9]> ** 4\-<[0..9]> ** 2\-<[0..9]> ** 2T<[0..9]> ** 2\:<[0..9]> ** 2\:<[0..9]> ** 2Z' '\[CRITICAL\]' '(.+)' 'at' 't\/05\-color\.t' 'line' '11\n$} {
...
subtest {
    ...
    if $out ~~ rx{^<[0..9]> ** 4\-<[0..9]> ** 2\-<[0..9]> ** 2T<[0..9]> ** 2\:<[0..9]> ** 2\:<[0..9]> ** 2Z' '\[WARN\]' '(.+)' 'at' 't\/05\-color\.t' 'line' '23\n$} {
...
subtest {
    ...
    if $out ~~ rx{^<[0..9]> ** 4\-<[0..9]> ** 2\-<[0..9]> ** 2T<[0..9]> ** 2\:<[0..9]> ** 2\:<[0..9]> ** 2Z' '\[INFO\]' '(.+)' 'at' 't\/05\-color\.t' 'line' '35\n$} {
